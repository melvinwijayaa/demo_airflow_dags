...
def glo_city_prod(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, stat, createdby, createddate, createdip, updatedby, updateddate, updatedip, name FROM jtiiasset.glo_city")
...
if __name__ == '__main__':
    ...
    fexec.call_async(glo_city_prod,'glo_city')
    print(fexec.get_result())