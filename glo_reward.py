...
def glo_reward_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_reward,tablename)
    print(fexec.get_result())    
    
def glo_reward(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, tipe, dari, ke, r1, r2, r3, lob FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO livejtiipayroll." +tablename+ "(id, tipe, dari, ke, r1, r2, r3, lob) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_reward,'glo_reward')
    print(fexec.get_result())
