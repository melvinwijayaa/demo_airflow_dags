...
def license_deployment_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(license_deployment,tablename)
    print(fexec.get_result())    
    
def license_deployment(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, stat, createdby, createddate, createdip, updatedby, updateddate, updatedip, date_deploy, date_undeploy, inventory_id, license_id FROM "+ tablename)
    ...
    cur2 = conn2.cursor()
    cur2.executemany("INSERT INTO jtiiasset." +tablename+ " (id, stat, createdby, createddate, createdip, updatedby, updateddate, updatedip, date_deploy, date_undeploy, inventory_id, license_id) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(license_deployment,'license_deployment')
    print(fexec.get_result())