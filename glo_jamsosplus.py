...
def glo_jamsosplus_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_jamsosplus,tablename)
    print(fexec.get_result())    
    
def glo_jamsosplus(tablename):
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_jamsosplus,'glo_jamsosplus')
    print(fexec.get_result())
