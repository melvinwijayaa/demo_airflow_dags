...
def proj_contractreg_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(proj_contractreg,tablename)
    print(fexec.get_result())    
    
def proj_contractreg(tablename):
    ...
    cur1 = conn1.cursor()
    cur1.execute("SELECT id, stat, createdby, createddate, \
                createdip, updatedby, updateddate, updatedip, idcat, projectname, periode1, periode2, \
                description, tcv, billtype, billtiming, planrevenue, plancost, plangp, currency, \
                idc, idcupdateddate, idcupdatedby, idcupdatedip, numbering, numberingcode, \
                numberingdate, numberingby, numberingip, iddept, angka1, angka2, angka3, \
                angka4, remark, signing, idmaster, grupdept, custid, status, servicecharge, \
                monthlycharge, fte, pm, notes, ot, mileage, shifting, travel, remote, \
                others, handphone, itsharedcost, estimatedbillingdates, mandays, \
                outstandingremark, projectshortname, billed, idc_composite FROM "+ tablename)
    ...
    cur2.executemany("INSERT INTO jtiiproms." +tablename+ "(id, stat, createdby, createddate, \
                ...
                monthlycharge, fte, pm, notes, ot, mileage, shifting, travel, remote, \
                others, handphone, itsharedcost, estimatedbillingdates, mandays, \
                outstandingremark, projectshortname, billed, idc_composite) \
                VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s)",records)
    conn2.commit()
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(proj_contractreg,'proj_contractreg')
    print(fexec.get_result())
