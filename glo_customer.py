...
def glo_customer_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_customer,tablename)
    print(fexec.get_result())    
    
def glo_customer(tablename):
    ...
    cur1.execute("SELECT id, stat, createdby, createddate, createdip, updatedby, updateddate, updatedip, \
                custno, abbvloc, abbvname, addrl1, addrl2, addrl3, addrl4, addrl5, addrl6, \
                npwp, npwpaddress FROM "+ tablename)
    ...
    cur2.executemany("INSERT INTO jtiiproms." +tablename+ "(id, stat, createdby, createddate, \
                createdip, updatedby, updateddate, updatedip, custno, abbvloc, abbvname,  \
                addrl1, addrl2, addrl3, addrl4, addrl5, addrl6, npwp, npwpaddress) \
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(glo_customer,'glo_customer')
    print(fexec.get_result())
