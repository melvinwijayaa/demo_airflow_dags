...
def proj_warmbodyreg_function(tablename):
    fexec = lithops.FunctionExecutor()
    fexec.call_async(proj_warmbodyreg,tablename)
    print(fexec.get_result())    
    
def proj_warmbodyreg(tablename):
    ...
    cur1.execute("SELECT id, stat, createdby, createddate, \
                ...
                angka4, remark, signing, idmaster, grupdept, custid, status FROM "+ tablename)
    ...
    cur2.executemany("INSERT INTO jtiiproms." +tablename+ "(id, stat, createdby, createddate, \
                ...
                idc, idcupdateddate, idcupdatedby, idcupdatedip, numbering, numberingcode, \
                numberingdate, numberingby, numberingip, iddept, angka1, angka2, angka3, \
                angka4, remark, signing, idmaster, grupdept, custid, status) \
                VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, \
                      %s, %s, %s, %s, %s, %s, %s, %s, %s, %s )",records)
    conn2.commit()
...
if __name__ == '__main__':
    fexec = lithops.FunctionExecutor()
    fexec.call_async(proj_warmbodyreg,'proj_warmbodyreg')
    print(fexec.get_result())
